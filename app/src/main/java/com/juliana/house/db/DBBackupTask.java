...
public class DBBackupTask extends AsyncTask<String,Void,Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        File dbFile = mContext.getDatabasePath("/data/data/com.juliana.house/databases/houses.db");
        File exportDir = new File(Environment.getExternalStorageDirectory(),
                "com.juliana.houseDBBackup");
        if (!exportDir.exists()) {
            exportDir.mkdirs();
        }
